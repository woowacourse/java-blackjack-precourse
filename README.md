...
16. (Business / **구현완료**) Player의 점수를 계산하는 기능.

17. (Business / **구현완료**) Dealer의 점수를 계산하는 기능.
...
21. (UI / **구현완료**) Dealer와 Player의 최종 결과를 출력하는 기능.

22. (Business) 게임 결과에 따라 Dealer와 각 Player의 수익을 계산하는 기능.

23. (Business) Dealer와 Player의 가장 처음 뽑은 2개의 카드가 블랙잭(합이 21)인 경우를 확인하는 기능.

24. (Business) 최종 게임 결과(수익)을 계산하는 기능.
...
25. (UI / **구현완료**) 최종 게임 결과(수익)을 출력하는 기능. 
