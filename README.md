...
- 배팅의 우선순위 문제
  - 만약 첫 두 패의 점수합이 블랙잭(21)일때, 딜러가 21을 넘겨서 졌다면 첫 두 패의 블랙잭에 따른 상금(1.5배)를 받아야 하는가? 아니면 딜러의 패배에 따른 상금(2배)를 받아야 하는가?
    *일단 첫 두 패가 블랙잭이면 게임에서 나간다고 가정하고 이후 연산에서 제외하도록 하였음.*
  - 무승부일 경우 돈을 잃는가?
