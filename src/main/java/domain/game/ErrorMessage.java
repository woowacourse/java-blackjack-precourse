...
public class ErrorMessage {
    public static final String PLAYER_IS_NOT_ENTERED = "플레이어 이름이 한명도 입력되지 않았습니다.\n다시 ";
    public static final String PLAYER_NAME_IS_TOO_SHORT = "플레이어 이름이 너무 짧습니다.\n다시 ";
    public static final String PLAYER_NAME_IS_DUPLICATED = "플레이어 이름이 중복되었습니다.\n다시 ";
