...
public class Printer {
	...
	public void printPlayerName(String name) {
		System.out.print(name + Constant.COLON);
	}

	public void printPlayerNameWithCard(String name) {
	...
	public void printZeroPrize() {
		System.out.println(Constant.ZERO_PRIZE);
	}
	
	public void printBettingMoney(double money) {
