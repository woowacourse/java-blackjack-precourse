...
public class inputView {
    private static final String MESSAGE_INPUT_PLAYER_NAME = "게임에 참여할 사람의 이름을 입력하세요";
    private static final String MESSAGE_INPUT_BETTING_MONEY = "의 베팅 금액은?";
    private static final String MESSAGE_INPUT_Y_OR_N = "은(는) 한 장의 카드를 더 받겠습니까?(예는 y, 아니오는 n)";
